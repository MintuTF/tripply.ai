...
import { Star, MapPin, ExternalLink, Plus, Bookmark, Hotel, Wifi, Coffee } from 'lucide-react';
...
export function HotelCard({ card, onAddToTrip, onSave, onClick }: HotelCardProps) {
      ...
      <div className="p-4">
        ...
        {card.amenities && card.amenities.length > 0 && (
          <div className="mb-3 flex flex-wrap gap-1.5">
            {card.amenities.slice(0, 3).map((amenity, i) => (
              <span
                key={i}
